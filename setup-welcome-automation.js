// Setup Welcome Email Automation in MailerLite
...
async function setupWelcomeAutomation() {
    console.log('🚀 Setting up Welcome Email Automation...\n');
    ...
    const welcomeEmailContent = `
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p>Thank you for signing up! Your personalized "From Boy to Man: A Reflection Guide" is ready.</p>
    ...
    try {
        ...
        const automationResponse = await fetch('https://connect.mailerlite.com/api/automations', {
            ...
            body: JSON.stringify({
                name: 'Welcome Email - Reflection Guide',
                type: 'welcome',
        ...
        if (automationResponse.ok) {
            ...
            console.log('✅ Welcome automation created successfully!');
            console.log('Automation ID:', automation.data.id);
            console.log('\n📧 Next steps:');
            console.log('1. Go to MailerLite dashboard');
            console.log('2. Find your automation in the Automations section');
            console.log('3. Activate it');
            console.log('4. Test by adding a subscriber');
        } else {
